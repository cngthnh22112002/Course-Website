...
{
    public abstract class CourseWebsiteWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static CourseWebsiteWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(CourseWebsiteWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<CourseWebsiteDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<CourseWebsiteDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<CourseWebsiteDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<CourseWebsiteDbContext, Task<T>> func)
        {
            T result;
